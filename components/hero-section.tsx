      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 text-center lg:text-left">
          <div className="space-y-2">
            <p className="text-muted-foreground text-5xl">Hola.</p>
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-balance">
              Yo soy <span className="text-primary text-8xl">Juan</span>
            </h1>
          </div>

          <div className="space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground/90">
              Desarrollador <span className="text-primary">Fullstack</span>
            </h2>
            <p className="text-2xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
          ...
          <div className="flex gap-4 justify-center lg:justify-start ">
            ...
            <br />
            <br />
            <Button size="lg" variant="outline" className="text-2xl" asChild>
